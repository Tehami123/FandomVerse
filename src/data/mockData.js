...
export const articles = [
  {
    id: 'a1', title: 'The Evolution of Mecha Design in Modern Anime', description: 'How silhouette, scale, and motion changed the language of giant robots.', subtitle: 'The machines keep getting louder, but the most lasting designs are learning how to say more with less.', author: 'A. Halloway', readTime: '5 min read', category: 'Anime', type: 'Article', tags: ['anime', 'design'], date: '2026-08-14', featured: true, relatedIds: ['a2', 'a3'], image: '/assets/anime/articles/article-anime-1.jpg', gallery: ['/assets/anime/gallery/anime-shrine-gallery.jpg', '/assets/anime/gallery/anime-city-gallery.jpg'],
    body: [
      { heading: 'Shape Before Spectacle', paragraphs: ['The newest generation of mecha design starts with a readable silhouette. Before a machine moves, a viewer should understand what kind of presence it has: a defender, a tool, a relic, or a threat.', 'That clarity gives the animation room to breathe. A shoulder line can establish weight, a visor can suggest temperament, and a single asymmetrical panel can imply a repair history without a paragraph of exposition.'] },
      { heading: 'Motion With Memory', paragraphs: ['Modern productions are also treating movement as part of the design rather than a final layer of polish. Heavy frames turn slowly, articulated machines hesitate before a strike, and damaged armor changes the rhythm of a later scene.', 'Those choices make action feel authored. The machine is not only a collection of impressive parts; it carries the consequences of every encounter into the next shot.'], quote: 'The best machine designs tell us how a world survives before they tell us how it fights.' },
      { heading: 'The Human Scale', paragraphs: ['Even the grandest robot works because a person has to live inside its proportions. Cockpit windows, maintenance seams, and awkward access points bring the fantasy back to a body-sized world.', 'That tension between the monumental and the intimate is where the current design language feels most alive. The future of mecha is not simply bigger hardware. It is more specific, more tactile, and more emotionally legible.'] },
    ],
  },
  {
    id: 'a2', title: 'Top 10 Upcoming RPGs of 2027', description: 'The role-playing worlds already on our radar for next year.', subtitle: 'A field guide to the new worlds, strange systems, and character-driven experiments worth watching next.', author: 'J. Curry', readTime: '8 min read', category: 'Gaming', type: 'Article', tags: ['gaming', 'RPG'], date: '2026-08-21', featured: true, relatedIds: ['a1', 'a3'], image: '/assets/gaming/articles/article-gaming-1.jpg', gallery: ['/assets/gaming/gallery/gaming-megacity-gallery.jpg', '/assets/gaming/gallery/gaming-arena-gallery.jpg'],
    body: [
      { heading: 'Worlds With A Point Of View', paragraphs: ['The most interesting role-playing games on the horizon are not competing on map size alone. They are building worlds around a clear argument about power, memory, community, or what a player owes the people inside a simulation.', 'That point of view shows up in the small systems: which doors stay locked, who remembers a broken promise, and whether a shortcut costs more than the long road. These details make a setting feel inhabited rather than merely enormous.'] },
      { heading: 'Systems That Invite Curiosity', paragraphs: ['Several of the upcoming worlds are making experimentation feel like progress. Builds are less about finding one perfect answer and more about discovering how two imperfect ideas interact.', 'The result is a welcome shift in the role of the player. Instead of following a prescribed path through a feature list, you are encouraged to make a theory, test it, and bring the consequences into the next chapter.'], quote: 'A good RPG does not just give you choices. It gives your choices a memory.' },
      { heading: 'The Party Is The Story', paragraphs: ['Character writing remains the strongest reason to keep an eye on this group of releases. The party is no longer just a set of combat roles; it is a living argument about the world and the player’s decisions inside it.', 'That promise is what makes the next wave compelling. The best of these games may not be the ones with the most content, but the ones that make a short exchange, a risky build, or a changed route feel worth remembering.'] },
    ],
  },
  {
    id: 'a3', title: 'Deconstructing the Cinematic Universe', description: 'Why interconnected stories still matter when every screen is crowded.', subtitle: 'The shared universe is evolving from a continuity puzzle into a new language for scale, surprise, and audience trust.', author: 'S. Oneill', readTime: '12 min read', category: 'Movies', type: 'Article', tags: ['movies', 'analysis'], date: '2026-08-29', featured: true, relatedIds: ['a1', 'a2'], image: '/assets/movies/articles/article-movies-1.jpg', gallery: ['/assets/movies/gallery/movie-theater-gallery.jpg'],
    body: [
      { heading: 'Beyond The Crossover', paragraphs: ['A cinematic universe used to announce itself with a collision: two heroes in one frame, a familiar emblem in the background, a promise that the next story would be larger. The newer experiments are quieter.', 'Connection now lives in tone, consequence, and recurring questions. A location returns changed. A side character carries a decision into another genre. The audience feels the architecture without needing every wall labeled.'] },
      { heading: 'Trust Is The Special Effect', paragraphs: ['Interconnection only works when each story can stand on its own. Viewers will follow a thread across films when the thread feels like a reward, not homework assigned before the opening scene.', 'That balance asks more from the writing. The world needs a consistent emotional logic even when its visual language changes, and every new entry has to earn its place before it expands the map.'], quote: 'A shared universe is strongest when the audience can feel the connection without being asked to solve it.' },
      { heading: 'Small Doors Into Large Worlds', paragraphs: ['The most durable cinematic universes are built from small doors: a prop with a history, a rumor that becomes a character, or a consequence that refuses to stay in the background.', 'Those details make scale feel personal. They leave space for discovery while keeping the individual story intact, which may be the most useful direction for crowded screens: fewer grand explanations, and more invitations to look closer.'] },
    ],
  },
];
...
export const trailers = [
  { id: 'tr1', title: 'Eclipse of Eden', status: 'Premiering Tomorrow', premiere: 'Tomorrow', format: 'Trailer', type: 'Trailer', category: 'Anime', description: 'A new chapter begins beneath a dying sky. As the last city prepares for eclipse, a small crew follows a signal that may rewrite the world below.', tags: ['Sci-Fi', 'Fantasy', 'Adventure'], image: '/assets/anime/trailers/trailer-anime-1.jpg', mediaSources: ['/assets/videos/10474633-hd_1920_1080_30fps.mp4', '/assets/videos/1630-148614385_medium.mp4', '/assets/videos/33517-397143847_medium.mp4'], gallery: ['/assets/anime/gallery/anime-shrine-gallery.jpg', '/assets/anime/gallery/anime-city-gallery.jpg'] },
  { id: 'tr2', title: 'Void Runner: 2099', status: 'Live Now', premiere: 'Now streaming', format: 'Trailer', type: 'Trailer', category: 'Gaming', description: 'The city core is watching. A resistance runner cuts through Neo-Kyoto’s surveillance grid while one final route opens beneath the towers.', tags: ['Cyberpunk', 'Action', 'RPG'], image: '/assets/gaming/trailers/trailer-gaming-1.jpg', mediaSources: ['/assets/videos/14098223_3840_2160_25fps.mp4', '/assets/videos/180776-865216724.mp4', '/assets/videos/21116-315137080.mp4'], gallery: ['/assets/gaming/gallery/gaming-megacity-gallery.jpg', '/assets/gaming/gallery/gaming-arena-gallery.jpg'] },
  { id: 'tr3', title: 'Silent Chorus', status: 'Coming Soon', premiere: 'Coming soon', format: 'Trailer', type: 'Trailer', category: 'Movies', description: 'Some signals are never meant to be answered. When a distant transmission breaks the silence, a crew of strangers must decide whether to follow it into the dark.', tags: ['Mystery', 'Drama', 'Sci-Fi'], image: '/assets/movies/trailers/movies-trailer-01.jpg', mediaSources: ['/assets/videos/130165-746395209_medium.mp4', '/assets/videos/91562-629172467.mp4'], gallery: ['/assets/movies/trailers/movies-trailer-01.jpg', '/assets/movies/gallery/movie-theater-gallery.jpg'] },
];
